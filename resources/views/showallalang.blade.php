  ...
  @if (isset($pusheditems) && count($pusheditems) > 0 )
          <div class="genre-prime-block">
            ...
            <div class="container-fluid">
              <h5 class="section-heading">{{__('staticwords.viewallin')}} {{ $alang->language }}</h5>
              <div class="">
                ...
                @if(isset($pusheditems))
                  ...
                  <div class="col-lg-2 col-md-3 col-xs-6 col-sm-4">
                      ...
                      <div class="genre-slide-image home-prime-slider protip" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block{{$item->id}}">
                        @if($auth && $subscribed==1)
                  ...
                  <div class="genre-slide-image home-prime-slider protip" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block{{$item->tvseries->id}}{{ $item->tvseries['type'] }}">
                    ...
                    <div id="prime-next-item-description-block{{$item->tvseries->id}}{{$item['tvseries']['type']}}" class="prime-description-block">
                        ...
                        <div class="des-btn-block">
                          ...
                          @if($catlog ==0 && $subscribed ==1)
                            @if (isset($wishlist_check->added))
                              <a onclick="addWish({{$item['id']}},'{{$item->tvseries['type']}}')" class="addwishlistbtn{{$item['id']}}{{$item->tvseries['type']}} btn-default">{{$wishlist_check->added == 1 ? __('staticwords.removefromwatchlist') : __('staticwords.addtowatchlist')}}</a>
                            @else
                              <a onclick="addWish({{$item->id}},'{{$item->tvseries['type']}}')" class="addwishlistbtn{{$item->id}}{{$item->tvseries['type']}} btn-default">{{__('staticwords.addtowatchlist')}}
                              </a>
                            @endif
                          @elseif($catlog ==1 && $auth)
                            @if (isset($wishlist_check->added))
