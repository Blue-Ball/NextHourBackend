                            ...
                            @if (isset($item->seasons[0]->episodes[0]))
                              @if($item->age_req == 'all age' || $age>=str_replace('+', '', $item->age_req))
                                @if(isset($item->seasons[0]) && $item->seasons[0]->episodes[0]->video_link['iframeurl'] !="")
                                  ...
                                  <a href="#" onclick="playoniframe('{{ $item->seasons[0]->episodes[0]->video_link['iframeurl'] }}','{{ $item->id }}','tv')" class="btn btn-play"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text">{{__('staticwords.playnow')}}</span>
                                   </a>
