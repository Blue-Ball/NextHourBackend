...
@section('title',__('adminstaticwords.PricingTextSetting'))
@section('content')
  <div class="admin-form-main-block mrg-t-40">
    <h4 class="admin-form-text"><a href="{{url('admin/packages')}}" data-toggle="tooltip" data-original-title="{{__('adminstaticwords.GoBack')}}" class="btn-floating"><i class="material-icons">reply</i></a>{{__('adminstaticwords.PricingTextSetting')}}</h4>
         ...
         <div class="form-group{{ $errors->has('package_id') ? ' has-error' : '' }}">
          ...
          {{-- title 1 --}}
            <div class="form-group{{ $errors->has('title1') ? ' has-error' : '' }}">
                {!! Form::label('title1',__('adminstaticwords.title1')) !!}
          ...
          {{-- title 2 --}}
            <div class="form-group{{ $errors->has('title2') ? ' has-error' : '' }}">
                {!! Form::label('title2', __('adminstaticwords.title2')) !!}
          ...
          {{-- title 3 --}}
            <div class="form-group{{ $errors->has('title3') ? ' has-error' : '' }}">
                {!! Form::label('title3', __('adminstaticwords.title3')) !!}
          ...
          {{-- title 4 --}}
            <div class="form-group{{ $errors->has('title4') ? ' has-error' : '' }}">
                {!! Form::label('title4', __('adminstaticwords.title4')) !!}
          ...
          {{-- title 5 --}}
            <div class="form-group{{ $errors->has('title5') ? ' has-error' : '' }}">
                {!! Form::label('title5', __('adminstaticwords.title5')) !!}
          ...
          {{-- title 6 --}}
            <div class="form-group{{ $errors->has('title6') ? ' has-error' : '' }}">
                {!! Form::label('title6', __('adminstaticwords.title6')) !!}
          ...
          <div class="">
            <button type="submit" class="btn btn-block btn-success">{{__('adminstaticwords.Update')}}</button>
          </div>
