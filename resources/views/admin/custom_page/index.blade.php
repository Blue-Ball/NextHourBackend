...
@section('title',__('adminstaticwords.AllCustomPage'))
@section('content')
  <div class="content-main-block mrg-t-40">
    <div class="admin-create-btn-block">
      <a href="{{route('custom_page.create')}}" class="btn btn-danger btn-md"><i class="material-icons left">add</i> {{__('adminstaticwords.CreateCustomPage')}}</a>
      <!-- Delete Modal -->
      ...
      <table id="custompageTable" class="table table-hover">
        <thead>
          <tr class="table-heading-row">
            ...
            <th>{{__('adminstaticwords.CustomPageTitle')}}</th>
