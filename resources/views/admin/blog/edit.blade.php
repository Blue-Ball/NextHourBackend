        ...
        <div class="col-md-10">
          ...
          <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }} input-file-block">
            ...
            <label for="image" class="btn btn-danger js-labelFile" data-toggle="tooltip" data-original-title="{{__('adminstaticwords.Image')}}">
              ...
              <span class="js-fileName">{{isset($blog->image) ? $blog->image :__('adminstaticwords.ChooseAFile')}}</span>
            </label>
           ...
           <div class=" form-group{{ $errors->has('detail') ? ' has-error' : '' }}">
                ...
                {!! Form::textarea('detail', old('detail'), ['id' => 'detail','autocomplete'=>'off', 'class' => 'form-control ckeditor', '']) !!}
