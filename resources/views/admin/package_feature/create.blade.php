...
@section('title',__('adminstaticwords.CreatePackageFeature'))
@section('content')
  <div class="admin-form-main-block mrg-t-40">
    <h4 class="admin-form-text"><a href="{{url('admin/package_feature')}}" data-toggle="tooltip" data-original-title="Go back" class="btn-floating"><i class="material-icons">reply</i></a> {{__('adminstaticwords.CreatePackageFeature')}}</h4>
    <div class="row">
      <div class="col-md-6">
