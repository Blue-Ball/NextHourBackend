...
@section('title',__('adminstaticwords.Edit')." ". $menu->name)
@section('content')
  <div class="admin-form-main-block mrg-t-40">
    <h4 class="admin-form-text"><a href="{{url('admin/menu')}}" data-toggle="tooltip" data-original-title="{{__('adminstaticwords.GoBack')}}" class="btn-floating"><i class="material-icons">reply</i></a> {{__('adminstaticwords.EditMenu')}}</h4>
    <div class="row">
      <div class="col-md-6">
        <div class="admin-form-block z-depth-1">
          {!! Form::model($menu, ['method' => 'PATCH', 'action' => ['MenuController@update', $menu->id]]) !!}
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                ...
                <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="{{__('adminstaticwords.PleaseEnterMenuName')}}eg:Home"></i>
                {!! Form::text('name', null, ['class' => 'form-control', 'required' => 'required']) !!}
                <small class="text-danger">{{ $errors->first('name') }}</small>
            </div>
            @if(count($menu->menusections)>0)
             <div class="form-group" class="form-group{{ $errors->has('section') ? ' has-error' : '' }}">
              <label>{{__('adminstaticwords.ChooseSection')}}: <span class="text-danger">*</span></label>
              <br>
              <small class="text-muted"> <i class="fa fa-question-circle"></i> {{__('adminstaticwords.MenuWillContainFollowingSection')}}</small>
              <br>
               <small class="text-muted"> <i class="fa fa-question-circle"></i> {{__('adminstaticwords.AtleaseOneSectionIsRequired')}}</small>
              ...
              <label>
                ...
                {{__('adminstaticwords.RecentlyAdded')}} 
              </label>
              <br>
              ...
              <div style="@foreach($menu->menusections as $section) @if($section->section_id == 1) display:block @else display:none @endif @endforeach " class="section1">
                  <div class="form-group">
                    <label>{{__('adminstaticwords.Limit')}}:</label>
                   ...
                   <div class="form-group">
                    <label>{{__('adminstaticwords.ViewIn')}}:</label>
                    <select name="view[1]" id="select1" class="form-control">
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 1 && $section->view == 1) selected="selected" @else  @endif  @endforeach value="1">{{__('adminstaticwords.SliderView')}}</option>
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 1 && $section->view == 0) selected="selected" @else  @endif  @endforeach value="0">{{__('adminstaticwords.GridView')}}</option>
                    </select>
                  </div>

                  <div class="form-group">
                    <label>{{__('adminstaticwords.OrderIn')}}:</label>
                    <select name="order[1]" id="select1" class="form-control">
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 1 && $section->order== 1) selected="selected" @else  @endif  @endforeach value="1">{{__('adminstaticwords.DESCOrder')}}</option>
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 1 && $section->order == 0) selected="selected" @else  @endif  @endforeach value="0">{{__('adminstaticwords.ASCOrder')}}</option>
                    </select>
                  </div>
              </div>
               ...
               <div style="@foreach($menu->menusections as $section) @if($section->section_id == 2) display:block @else display:none @endif @endforeach " class="section2">
                  ...
                  <div class="form-group">
                    ...
                    <select name="view[2]" id="select2" class="form-control">
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 2 && $section->view == 1) selected="selected" @else  @endif  @endforeach value="1">{{__('adminstaticwords.SliderView')}}</option>
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 2 && $section->view == 0) selected="selected" @else  @endif  @endforeach value="0">{{__('adminstaticwords.GridView')}}</option>
                    </select>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <select name="order[2]" id="select2" class="form-control">
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 2 && $section->order== 1) selected="selected" @else  @endif  @endforeach value="1">{{__('adminstaticwords.DESCOrder')}}</option>
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 2 && $section->order == 0) selected="selected" @else  @endif  @endforeach value="0">{{__('adminstaticwords.ASCOrder')}}</option>
                    </select>
                  </div>
              </div>
              <br>
              <label>
               ...
               <div style="@foreach($menu->menusections as $section) @if($section->section_id == 3) display:block @else display:none @endif @endforeach " class="section3">
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <select name="view[3]" id="select3" class="form-control">
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 3 && $section->view == 1) selected="selected" @else  @endif  @endforeach value="1">{{__('adminstaticwords.SliderView')}}</option>
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 3 && $section->view == 0) selected="selected" @else  @endif  @endforeach value="0">{{__('adminstaticwords.GridView')}}</option>
                    </select>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <select name="order[3]" id="select3" class="form-control">
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 3 && $section->order== 1) selected="selected" @else  @endif  @endforeach value="1">{{__('adminstaticwords.DESCOrder')}}</option>
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 3 && $section->order == 0) selected="selected" @else  @endif  @endforeach value="0">{{__('adminstaticwords.ASCOrder')}}</option>
                    </select>
                  </div>
              </div>
                <br>
               ...
               <label>
                ...
                {{__('adminstaticwords.BestOnIntrest')}}
              </label>
               <div style="@foreach($menu->menusections as $section) @if($section->section_id == 4) display:block @else display:none @endif @endforeach " class="section4">
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <select name="view[4]" id="select4" class="form-control">
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 4 && $section->view == 1) selected="selected" @else  @endif  @endforeach value="1">{{__('adminstaticwords.SliderView')}}</option>
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 4 && $section->view == 0) selected="selected" @else  @endif  @endforeach value="0">{{__('adminstaticwords.GridView')}}</option>
                    </select>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <select name="order[4]" id="select4" class="form-control">
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 4 && $section->order== 1) selected="selected" @else  @endif  @endforeach value="1">{{__('adminstaticwords.DESCOrder')}}</option>
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 4 && $section->order == 0) selected="selected" @else  @endif  @endforeach value="0">{{__('adminstaticwords.ASCOrder')}}</option>
                    </select>
                  </div>
              </div>
              ...
              <br/>
                ...
                {{__('adminstaticwords.ContinueWatch')}}
              </label>
               <div style="@foreach($menu->menusections as $section) @if($section->section_id == 5) display:block @else display:none @endif @endforeach " class="section5">
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <select name="view[5]" id="select5" class="form-control">
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 5 && $section->view == 1) selected="selected" @else  @endif  @endforeach value="1">{{__('adminstaticwords.SliderView')}}</option>
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 5 && $section->view == 0) selected="selected" @else  @endif  @endforeach value="0">{{__('adminstaticwords.GridView')}}</option>
                    </select>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <select name="order[5]" id="select5" class="form-control">
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 5 && $section->order== 1) selected="selected" @else  @endif  @endforeach value="1">{{__('adminstaticwords.DESCOrder')}}</option>
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 5 && $section->order == 0) selected="selected" @else  @endif  @endforeach value="0">{{__('adminstaticwords.ASCOrder')}}</option>
                    </select>
                  </div>
              </div>
              <br/>
               ...
               <div style="@foreach($menu->menusections as $section) @if($section->section_id == 6) display:block @else display:none @endif @endforeach " class="section6">
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <select name="view[6]" id="select6" class="form-control">
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 6 && $section->view == 1) selected="selected" @else  @endif  @endforeach value="1">{{__('adminstaticwords.SliderView')}}</option>
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 6 && $section->view == 0) selected="selected" @else  @endif  @endforeach value="0">{{__('adminstaticwords.GridView')}}</option>
                    </select>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <select name="order[6]" id="select6" class="form-control">
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 6 && $section->order== 1) selected="selected" @else  @endif  @endforeach value="1">{{__('adminstaticwords.DESCOrder')}}</option>
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 6 && $section->order == 0) selected="selected" @else  @endif  @endforeach value="0">{{__('adminstaticwords.ASCOrder')}}</option>
                    </select>
                  </div>
              </div>
              <br/>
              ...
              <label>
                ...
                {{__('adminstaticwords.MovieTvseriesPramotion')}}
              </label>
              <br/>
              <label>
                <div class="inline">
              ...
              <label>
                ...
                {{__('adminstaticwords.UpcomingMovie')}}
              </label>
              ...
              <div style="display: none" class="section1">
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    <label>{{__('adminstaticwords.ViewIn')}}:</label>
                    <select name="view[1]" id="select1" class="form-control">
                      <option value="1">{{__('adminstaticwords.SliderView')}}</option>
                      <option value="0">{{__('adminstaticwords.GridView')}}</option>
                    </select>
                  </div>
                   ...
                   <div class="form-group">
                    <label>{{__('adminstaticwords.OrderIn')}}:</label>
                    <select name="order[1]" id="select1" class="form-control">
                      <option value="1">{{__('adminstaticwords.DESCOrder')}}</option>
                      <option value="0">{{__('adminstaticwords.ASCOrder')}}</option>
                    </select>
                  </div>
              </div>
