          ...
          <ul>
            ...
            <li> 
              <div id="ex4" class="dropdown prime-dropdown">
                  ...
                  <button class="btn btn-primary dropdown-toggle notification-dropdown" type="button" data-toggle="dropdown" data-count="<?php echo e(auth()->user()->unreadnotifications->count()); ?>">
                    ...
                    <li>
                      ...
                      <div id="notification_id" onclick="readed('<?php echo e($n->id); ?>')" class="card" style="padding: 6px;" >
                        ...
                        <p style="margin-top: -6px; font-size: 16px;"> <?php echo e($n->data['data']); ?> &nbsp; 
                          <?php if(isset($tv)): ?>
                            <a type="button" href="<?php echo e(url('show/detail',$season->season_slug)); ?>" style="font-size: 16px; color:  #a9ea81">
                              <b> "<?php echo e($tv->title); ?>"</b></a>
                          <?php endif; ?> 
                          &nbsp;
                          <?php if(isset($moviename)): ?>
                            <a type="button" href="<?php echo e(url('movie/detail', $movieslug)); ?>" style="font-size: 16px;color: #a9ea81">
            ...
            <li class="sign-in-block language-switch-block">
              <div class="dropdown prime-dropdown">
                <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown"><i class="flaticon-translate"></i> <?php echo e(Session::has('changed_language') ? ucfirst(Session::get('changed_language')) : ''); ?></button>
            ...
            <li class="sign-in-block admin-dropdown">
              <div class="dropdown prime-dropdown">
                <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton1" data-toggle="dropdown"><i class="fa fa-user-circle"></i> <?php if(Session::has('nickname')): ?> <?php echo e(Session::get('nickname')); ?> <?php else: ?> <?php echo e($auth ? $auth->name : ''); ?> <?php endif; ?>
            ...
            <?php else: ?>
            <li class="sign-in-block sign-in-block-one sign-in-block-two mrgn-rt-20"><a class="sign-in" href="<?php echo e(url('login')); ?>"><i class="flaticon-login"></i> <?php echo e(__('staticwords.signin')); ?></a></li>
            <li class="sign-in-block sign-in-block-one "><a class="sign-in" href="<?php echo e(url('register')); ?>"><i class="flaticon-profile"></i><?php echo e(__('staticwords.register')); ?></a></li>
            <?php endif; ?>
          </ul>
        </div>
      </div>
...
<?php /**PATH /var/www/html/resources/views/layouts/theme.blade.php ENDPATH**/ ?>