...
<?php $__env->startSection('title',__('adminstaticwords.ManageEpisodes')); ?>
<style type="text/css">
    body{
...
<div id="myyoutubeModal" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <h4 class="admin-form-text"><a href="<?php echo e(url('admin/tvseries', $season->tvseries->id)); ?>" data-toggle="tooltip" data-original-title="Go back" class="btn-floating"><i class="material-icons">reply</i></a> <?php echo e(__('adminstaticwords.ManageEpisodes')); ?> <span><?php echo e(__('adminstaticwords.Of')); ?> <?php echo e($season->tvseries->title); ?> Season <?php echo e($season->season_no); ?>
...
<div id="myvimeoModal" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <div class="admin-create-btn-block">
      <a id="createButton" onclick="showCreateForm()" class="btn btn-danger btn-md"><i class="material-icons left">add</i> <?php echo e(__('adminstaticwords.CreateEpisode')); ?></a>
    </div>
    ...
    <div class="upload-image-main-block" style="display: none;">
      ...
      <div class="form-group<?php echo e($errors->has('selecturl') ? ' has-error' : ''); ?>">
        ...
        <?php echo Form::select('selecturl', array('iframeurl' => __('adminstaticwords.IframeURLAndEmbedURL'), 
              ...
              <div style="display: none;" id="custom_url">
                ...
                <div class="form-group<?php echo e($errors->has('url_720') ? ' has-error' : ''); ?>">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                         <?php echo Form::label('upload_video', 'UploadVideoIn720p'); ?> - <p class="inline info"><?php echo e(__('adminstaticwords.ChooseAVideo')); ?></p>
                ...
                <div class="form-group<?php echo e($errors->has('url_1080') ? ' has-error' : ''); ?>">
                   ...
                   <div class="row">
                     ...
                     <div class="col-md-4">
                      <?php echo Form::label('upload_video', __('adminstaticwords.UploadVideoIn1080p')); ?> - <p class="inline info">Choose A Video</p>
          ...
          <table class="table table-hover">
            <thead>
              <tr class="table-heading-row side-table">
                <th>#</th>
                <th><?php echo e(__('adminstaticwords.Title')); ?></th>
            ...
            <?php if($episodes): ?>
              ...
              <?php $__currentLoopData = $episodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $episode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr>
                  ...
                  <td><?php echo e($episode->duration); ?> <?php echo e(__('adminstaticwords.mins')); ?></td>
                  <td>
                    <div class="admin-table-action-block side-table-action">
                       <a href="<?php echo e(route('episode.link', $episode->id)); ?> " data-toggle="tooltip" data-original-title="<?php echo e(__('adminstaticwords.links')); ?>"  class="btn-success btn-floating"><i class="material-icons">link</i></a>
                      <a href="<?php echo e(route('edit_episodes',['id'=>$season->id,'ep_id'=>$episode->id])); ?>" data-toggle="tooltip" data-original-title="<?php echo e(__('adminstaticwords.Edit')); ?>" class="btn-info btn-floating"><i class="material-icons">mode_edit</i></a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/tvseries/episodes.blade.php ENDPATH**/ ?>