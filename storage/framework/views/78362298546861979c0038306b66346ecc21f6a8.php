        ...
        <div class="admin-form-block z-depth-1">
          <?php echo Form::open(['method' => 'POST', 'action' => 'GenreController@store','files' => true]); ?>
            ...
            <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                ...
                <?php echo Form::text('name', old('name'), ['class' => 'form-control','placeholder' => __('adminstaticwords.PleaseEnterGenreName')]); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/genre/create.blade.php ENDPATH**/ ?>