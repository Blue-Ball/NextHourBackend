...
<?php $__env->startSection('title', __('adminstaticwords.PrivacyPolicy')); ?>
<?php $__env->startSection('content'); ?>
  <div class="admin-form-main-block mrg-t-40">
    <h4 class="admin-form-text"><?php echo e(__('adminstaticwords.PrivacyPolicyText')); ?></h4>
    <?php if($config): ?>
      <div class="admin-form-block z-depth-1">
        ...
        <div class="form-group<?php echo e($errors->has('privacy_pol') ? ' has-error' : ''); ?>">
          <?php echo Form::label('privacy_pol', __('adminstaticwords.PrivacyPolicyText')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/pri_pol.blade.php ENDPATH**/ ?>