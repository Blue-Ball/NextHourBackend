...
<?php $__env->startSection('title',__('adminstaticwords.AllLanguages')); ?>
<?php $__env->startSection('content'); ?>
  <div class="content-main-block mrg-t-40">
    <div class="admin-create-btn-block">
      <a href="<?php echo e(route('languages.create')); ?>" class="btn btn-danger btn-md"><i class="material-icons left">add</i> <?php echo e(__('adminstaticwords.CreateLanguage')); ?></a>
      <!-- Delete Modal -->
        ...
        <thead>
          <tr class="table-heading-row">
            <th>
             ...
             <th><?php echo e(__('adminstaticwords.Local')); ?></th>
            <th><?php echo e(__('adminstaticwords.Name')); ?></th>
            <th><?php echo e(__('adminstaticwords.Default')); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/language/index.blade.php ENDPATH**/ ?>