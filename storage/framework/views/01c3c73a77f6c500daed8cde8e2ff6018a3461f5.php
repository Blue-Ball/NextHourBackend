...
<?php $__env->startSection('title',__('adminstaticwords.EditGenre').''." - $genre->name"); ?>
<?php $__env->startSection('content'); ?>
  <div class="admin-form-main-block mrg-t-40">
    <h4 class="admin-form-text"><a href="<?php echo e(url('admin/genres')); ?>" data-toggle="tooltip" data-original-title="<?php echo e(__('adminstaticwords.GoBack')); ?>" class="btn-floating"><i class="material-icons">reply</i></a> <?php echo e(__('adminstaticwords.EditGenre')); ?></h4>
    <div class="row">
      <div class="col-md-6">
            ...
            <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
             ...
             <div class="form-group<?php echo e($errors->has('genre') ? ' has-error' : ''); ?> input-file-block">
              ...
              <label for="image" class="btn btn-danger js-labelFile" data-toggle="tooltip" data-original-title="genre image">
                ...
                <span class="js-fileName"><?php echo e(isset($genre->image) ? $genre->image :__('adminstaticwords.ChooseAFile')); ?></span>
              </label>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/genre/edit.blade.php ENDPATH**/ ?>