      ...
      <table id="full_detail_table" class="table table-hover">
        <thead>
          <tr class="table-heading-row">
            ...
            <th><?php echo e(__('adminstaticwords.Delete')); ?></th>
          </tr>
        </thead>
        <?php if($coupons): ?>
          <tbody>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/coupon/index.blade.php ENDPATH**/ ?>