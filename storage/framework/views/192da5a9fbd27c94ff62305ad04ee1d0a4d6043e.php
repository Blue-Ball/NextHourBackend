...
<?php $__env->startSection('title',__('adminstaticwords.AllSlider')); ?>
<?php $__env->startSection('content'); ?>
  <div class="content-main-block mrg-t-40">
    <div class="admin-create-btn-block">
      <a href="<?php echo e(route('home_slider.create')); ?>" class="btn btn-danger btn-md"><i class="material-icons left">add</i> <?php echo e(__('adminstaticwords.AddSlide')); ?></a>
      <!-- Delete Modal -->
        ...
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body text-center">
              ...
              <p><?php echo e(__('adminstaticwords.DeleteSelected')); ?></p>
            </div>
    ...
    <div class="content-block box-body content-block-two">
      <table id="full_detail_table" class="table table-hover db">
        <thead>
          ...
          <th><?php echo e(__('adminstaticwords.SlideImage')); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/homeslider/index.blade.php ENDPATH**/ ?>