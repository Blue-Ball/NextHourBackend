...
<?php $__env->startSection('title',__('adminstaticwords.LandingPages')); ?>
<?php $__env->startSection('content'); ?>
  <div class="content-main-block mrg-t-40">
    <div class="admin-create-btn-block">
      <a href="<?php echo e(route('landing-page.create')); ?>" class="btn btn-danger btn-md"><i class="material-icons left">add</i> <?php echo e(__('adminstaticwords.CreateABlock')); ?></a>
      <!-- Delete Modal -->
      ...
      <table id="full_detail_table" class="table table-hover db">
        <thead>
          <tr class="table-heading-row">
            ...
            <th><?php echo e(__('adminstaticwords.Heading')); ?></th>
            <th><?php echo e(__('adminstaticwords.Details')); ?></th>
            <th><?php echo e(__('adminstaticwords.Button')); ?></th>
            <th><?php echo e(__('adminstaticwords.ImagePosition')); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/landing-page/index.blade.php ENDPATH**/ ?>