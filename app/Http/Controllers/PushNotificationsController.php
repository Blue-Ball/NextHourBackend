...
class PushNotificationsController extends Controller
{
    ...
    public function push(Request $request)
    {
        ...
        if(env('ONESIGNAL_APP_ID') =='' && env('ONESIGNAL_REST_API_KEY') == ''){
            ...
            return back()->withInput()->with('deleted','Please update onesignal keys in settings !, Keys not found !');
        }
        ...
        try {
            ...
            return back()->with('added','Notification pushed successfully !');
    ...
    public function updateKeys(Request $request){
        ...
        return back()->with('added', 'OneSignal Keys updated successfully !');
    }
}
