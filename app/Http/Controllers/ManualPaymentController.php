    ...
    public function store(Request $request, $planid)
    {
        ...
        if($created_subscription){
            ...
            if (isset($menus) && count($menus) > 0)
              {
              return redirect()->route('home', $menus[0]->slug)->with('added', 'ManualPayment Recipt has been successfully Added !');
            }else{
                return redirect('/')->with('added', 'ManualPayment Recipt has been successfully Added !');
            }
