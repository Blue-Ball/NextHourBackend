...
class InstallerController extends Controller
{
    ...
    public function storeeula(Request $request)
    {
        ...
        if (isset($request->eula)) {
            ...
            return back()->with('deleted','Please Accept Terms and conditions first !');
        }
    ...
    public function storeBasicSetup(Request $request)
    {
        ...
        if ($apistatus == 1) {
            ...
            return redirect()->route('installApp')->withInput()->with('Oops Please try again !');
    ...
    public function step2(Request $request)
    {
        ...
        //     return redirect()->route('db.setup')->withInput($request->except('DB_PASSWORD'))->with('deleted',$e->getMessage());
